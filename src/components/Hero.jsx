          ...
          >
            ...
            >
              <Button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 text-lg sm:text-xl font-medium transition-all duration-200 transform hover:scale-105"
              >
                View My Work
              </Button>
              <Button
                ...
                variant="outline"
                className="border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-3 text-lg sm:text-xl font-medium transition-all duration-200 transform hover:scale-105"
              >
                Get In Touch
              </Button>
            </motion.div>
